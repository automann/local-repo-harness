...
print_report() {
  ...
  echo "- VCS profile: ${REPO_HARNESS_VCS_PROFILE:-self-host} (install=${REPO_HARNESS_INSTALL_STATE_VCS_SCOPE:-${REPO_HARNESS_VCS_SCOPE:-tracked}}, workflow=${REPO_HARNESS_WORKFLOW_STATE_VCS_SCOPE:-${REPO_HARNESS_VCS_SCOPE:-tracked}}, product-intent=${REPO_HARNESS_PRODUCT_INTENT_VCS_SCOPE:-${REPO_HARNESS_VCS_SCOPE:-tracked}}; tracked whitelist=${REPO_HARNESS_TRACKED_WHITELIST:-})"
