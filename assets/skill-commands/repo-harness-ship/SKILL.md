...
5. After a PR has merged and local `main` contains the branch, run `bash scripts/ship-worktrees.sh --cleanup-merged` to remove only proven-merged local worktrees and branches.
